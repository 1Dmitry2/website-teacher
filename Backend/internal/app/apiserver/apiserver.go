...
func Start(config *Config) error {
	...
	srv := newServer(store, config.JWTSecret, mailerService, config.Admin.ResetURL, config.User.VerificationURL, config.User.ResetURL, config.UploadDir, config.CORSOrigins)
